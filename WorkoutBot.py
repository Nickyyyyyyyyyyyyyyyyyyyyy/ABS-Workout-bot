...
def generate_workouts():
    ...
    base_workouts = {
        ...
        56: [
            "**Бічна планка (вправо):** {} секунд",
            "**Бічна планка (вліво):** {} секунд",
            "**Дорсальне підняття:** {} повторень", # Виправлено: зайві ** після ":"
            "**Торкання п'ят:** {} повторень",
            "**Бічна планка (підйом ноги вліво):** {} секунд",
            "**Бічна планка (підйом ноги вправо):** {} секунд"
        ],
        ...
        61: [
            "**Зворотні кранчі:** {} повторень",
            "**Кранчі:** {} повторень",
            "**Бічна планка (вправо):** {} секунд", # Виправлено: зайві ** після ":"
            "**Бічна планка (вліво):** {} секунд",
            "**Дорсальне підняття:** {} повторень",
            "**Велосипед:** {} повторень"
        ],
...
def main() -> None:
    # Вставте сюди свій токен бота
    TOKEN = "7578887710:AAGk_MrXE9M1yLQ21FcS9F2C2j9GFxTyWKs" # <-- ОБОВ'ЯЗКОВО ЗАМІНІТЬ ЦЕ НА ВАШ ТОКЕН!
    application = Application.builder().token(TOKEN).build()

    # Додаємо обробники команд
    application.add_handler(CommandHandler("start", start))
    application.add_handler(CommandHandler("list", list_days)) # Новий обробник для команди /list
    application.add_handler(CallbackQueryHandler(button_handler)) # Обробник для кнопок
